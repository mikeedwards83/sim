        ...
        <>
            <section className="bg-white ">
                <div
                    ...
                    <div className="col-span-2 mb-8">
                        <p className="text-lg font-medium text-purple-600 ">v0.1</p>
            ...
            <section className="bg-gray-50 ">
                <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                    <div>
                        <h2 className="mt-3 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl ">Version 0.1</h2>
                        <h4 className="mb-2 text-xl  m-0 ">Updated: 15 October 2022</h4>
                    </div>
                    <Tabs.Group
                        aria-label="Pills"
                        style="default"
